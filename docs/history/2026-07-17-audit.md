...
> Historical record from 2026-07-17. This audit describes the pre-beta state and must not be used to assess the current `v2.6.1-beta.1` artifact. See the [current public beta checklist](../public-beta-checklist.md) for the verified distribution status.
